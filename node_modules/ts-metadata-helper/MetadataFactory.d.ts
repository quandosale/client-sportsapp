...
export declare const PROP_METADATA: string;
export declare const ANNOTATIONS_METADATA: string;
...
export declare type DecoratorType = {
    new (): IDecorator;
};
export interface IMetadataDefinition {
    [index: string]: Array<AnnotationType>;
}
export declare function PropertyAnnotationFactory(annotationMetadata: IAnnotationMetadata): IAnnotation;
