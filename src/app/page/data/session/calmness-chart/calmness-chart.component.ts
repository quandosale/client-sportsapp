...
declare let $: any;
@Component({
  selector: 'calmness-chart',
  templateUrl: './calmness-chart.component.html',
  styleUrls: ['./calmness-chart.component.css']
})

export class CalmnessChartComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit() {
    this.plot = $(this.elNode.nativeElement).find('#calmgraph').empty();
