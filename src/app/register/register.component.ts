...
export class RegisterComponent {
  ...
  register(): void {
    ...
    if (this.user.firstname == null || this.user.secondname == null || this.user.sec_question == null
      || this.user.sec_answer == null || this.user.password == null || this.rePassword == null) {
    ...
    console.log(this.onEmail + ':' + this.onRegister + ':' + this.onPassword);
